...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    @Deprecated
        ...
        /**
         * Creates a dependency provider for khealth (dev.hayden:khealth)
         * This dependency was declared in catalog libs.versions.toml
     * @deprecated Will be removed in Gradle 9.0.
         */
    @Deprecated
        public Provider<MinimalExternalModuleDependency> getKhealth() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("khealth");
    }
    ...
    public static class KtorServerLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorServerMetricsLibraryAccessors laccForKtorServerMetricsLibraryAccessors = new KtorServerMetricsLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at ktor.server.metrics
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorServerMetricsLibraryAccessors getMetrics() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorServerMetricsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorServerMetricsLibraryAccessors extends SubDependencyFactory {

        public KtorServerMetricsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PrometheusVersionAccessors vaccForPrometheusVersionAccessors = new PrometheusVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.prometheus
         */
        public PrometheusVersionAccessors getPrometheus() {
            return vaccForPrometheusVersionAccessors;
        }
    ...
    public static class PrometheusVersionAccessors extends VersionFactory  {

        public PrometheusVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: prometheus.version (1.6.13)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getVersion() { return getVersion("prometheus.version"); }
